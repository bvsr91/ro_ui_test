		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MRO E-Catalog",
									"targetURL": "#comferrerozmrouiapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comferrerozmrouiapp-display": {
								"semanticObject": "comferrerozmrouiapp",
								"action": "display",
								"description": "App",
								"title": "MRO E-Catalog",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ferrero.zmrouiapp",
									"url": sap.ui.require.toUrl("com/ferrero/zmrouiapp")
								}
							}
						}
					}
